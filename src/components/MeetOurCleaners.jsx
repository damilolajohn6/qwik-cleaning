...
const MeetOurCleaners = () => {
  return (
    <section className="py-16 px-6 md:px-20">
      <h2 className="text-2xl md:text-3xl font-bold mb-2">Meet Our Cleaners</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-gray-100 p-4 rounded-lg max-w-xl">
        <div className="relative w-full sm:w-2/3">
          <select className="appearance-none w-full p-3 rounded-md bg-gray-100 border border-gray-300 pr-10">
